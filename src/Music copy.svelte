...
{:else}
    <div class="w-3/4 mx-auto">
    <p class="text-base lowercase">i've been listening to <a href="" class="font-bold animate-pulse">someone from lastfm</a> a lot lately. my favorite song right now is <a class="font-bold animate-pulse">song from lastfm - some artist</a></p>
    <div class="relative w-screen ml-[calc(-55vw)] left-1/2 mb-12 mt-2 [mask-image:linear-gradient(to_right,#000_0%,#000_75%,#0000_100%)] lg:[mask-image:linear-gradient(to_right,#0000_0%,#000_25%,#000_75%,#0000_100%)] before:z-10">
        <div class="lg:px-[calc(50vw-400px)] md:px-[calc(50vw-350px)] px-8 lg:scroll-pl-[calc(50vw-400px)] md:scroll-pl-[calc(50vw-350px)] scroll-pl-8 grid grid-rows-2 grid-cols-[repeat(12,calc(9rem))] md:grid-cols-[repeat(12,calc(12rem))] lg:grid-cols-[repeat(12,calc(14rem))] grid-flow-col gap-4 overflow-scroll no-scrollbar snap-x snap-mandatory rise-wrapper">
        {#each [...Array(24)] as _, i}
                ...
                <a
                    ...
                    style={`--delay: ${i * 100 + 200}ms`}
                >
                    <div class="bg-slate-900 h-56 w-56 rounded-lg overflow-hidden">
                    </div>
                    <div class="z-20 absolute inset-2 md:inset-4 flex flex-col justify-end transition duration-300 h-1/2 scale-95 opacity-0 group-hover:scale-100 group-hover:opacity-100 lowercase">
                        <p class="font-bold text-xl md:text-2xl truncate leading-none md:leading-none mb-1">
                            loading
                        </p>
                        <p
