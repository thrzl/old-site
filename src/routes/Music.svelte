...
{#await lastfm}
	<div class="w-3/4 mx-auto">
		...
		>
			<div
				class="lg:px-[calc(50vw-400px)] md:px-[calc(50vw-350px)] px-8 lg:scroll-pl-[calc(50vw-400px)] md:scroll-pl-[calc(50vw-350px)] scroll-pl-8 grid grid-rows-2 grid-cols-[repeat(24,calc(9rem))] md:grid-cols-[repeat(24,calc(12rem))] lg:grid-cols-[repeat(24,calc(14rem))] grid-flow-col gap-4 overflow-x-scroll no-scrollbar snap-x snap-mandatory"
			>
